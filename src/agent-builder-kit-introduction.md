...
- `docs-builder.toml`: builder が読み込む設定ファイルです。生成する docs 構成、planning layout、profile、add-on pack はこのファイルで決まります。`agent-builder-kit/DOCS_BUILDER_TOML` を参考に、プロジェクトに合わせて編集してからルート下へ配置してください。
